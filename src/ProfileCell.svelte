<div class="cell h-full">
  ...
  <div class="cell-body flex flex-col h-full">
    ...
    <div class="flex gap-3 mt-1 flex-1 content-center">
      ...
      <div>
        <h1 class="font-display text-paper leading-none" style="font-size: clamp(24px, 3.5vw, 34px);">
          Omar
        </h1>
    ...
    <div class="flex flex-col gap-2.5 pb-1 mt-2">
      <a
        href="https://github.com/opmr0"
        target="_blank"
        rel="noopener"
        class="flex items-center gap-2 group"
        style="text-decoration: none;"
      >
        <svg width="13" height="13" fill="#444" viewBox="0 0 24 24" class="group-hover:fill-subtle transition-colors duration-150">
        ...
        <span class="font-mono text-dim group-hover:text-subtle transition-colors duration-150" style="font-size: 10px;">
          github.com/opmr0
        </span>
      </a>
    </div>
